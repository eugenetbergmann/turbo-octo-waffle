...
| 02 | Core state tables + usp_state_refresh | Pending |
...
- `sql/procs/usp_replicate_po.sql` — PO header + detail replication
...
- `sql/procs/usp_replicate_vendor.sql` — Vendor + lot replication
